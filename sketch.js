...
function setup() {
	...
	dropzone1=createSprite(400,640,200,20);
	dropzone1.shapeColor=color("red");

	dropzone2=createSprite(300,600,20,100);
	dropzone2.shapeColor=color("red");

	dropzone3=createSprite(500,600,20,100);
	...
	ground = Bodies.rectangle(width/2, 650, width, 10 , {isStatic:true} );
	 ...
	 dropzone1 = Bodies.rectangle(400 ,630 , 200, 20 , {isStatic:true} );
